...
export default function Home() {
  ...
  const [messages, setMessages] = useState([
    { role: "assistant", content: "Hello, I am ChatGPT Apollo, how may I help you?" }
  ]);
  ...
  return (
    <>
      <Head>
        ...
        <link rel="icon" href="https://clever.com/favicon.ico" />
      </Head>
      <div className={styles.topnav}>
        ...
        <div className={styles.navlinks}>
          <a href="https://k.soursmp.cf" target="_blank">Home</a>
        </div>
      </div>
      <main className={styles.main}>
        ...
        <div className={styles.center}>
          ...
          <div className={styles.footer}>
            <p>From <a href="https://ap.scythx.cf/" target="_blank">Apollo</a>.</p>
          </div>
        </div>
      </main>
    </>
